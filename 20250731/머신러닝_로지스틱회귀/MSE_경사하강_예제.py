...
x_data = np.array([0.65, 0.70 , 0.75, 0.80, 0.45, 0.60, 0.70, 0.65, 0.70, 0.80, 0.50, 0.38])  # 연산을 위해 몸무게 스케일 조정
y_data = np.array([160, 175, 170, 180, 150, 160, 174, 165, 172, 178, 155, 145])
